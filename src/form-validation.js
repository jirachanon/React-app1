    ...
    const onSummitForm = (event) => {
        ...
        for (let f of inputFile.current.files) {
            if (f.size > maxSize * 1000) {
                alert(`ขนาดไฟล์เกิน ${maxSize} KB/ไฟล์`)
                event.preventDefault()
                return
            }
        }
        ...
        return (
            <div className="mt-3 mb-5 mx-auto p-3 rounded"
                style={{width:'400px', background:'#cee'}}>
                    ...
                    <form onSubmit={handleSubmit(onSummitForm)}>
                        ...
                        <div className="form-group mb-3">
                            ...
                            {error.name && <div style={err}>กรุณาระบุชื่อสินค้า</div>}
                        </div>
                        ...
                        <div className="form-group mb-3">
                            ...
                            {error.price && <div style={err}>กำหนดราคาสินค้ามากกว่า 0</div>}
                        </div>
                        ...
                        <div className="form-group mb-3">
                            ...
                            {error.detail && <div style={err}>ต้องกำหนดรายละเียดสินค้า</div>}
                        </div>
